  ...
  static List<Item> generatePlaceholders() {
    ...
    return [
      Item(
          ...
          seller: users[0],
          title: "Dishwasher",
          description: "I am giving away my dishwasher! It has 8 years now, but it is still working (with some weird noise sometimes, but not too loud). If you want it reach me out in direct messages! I need to give it away before the 15th April.",
          mainImage: "https://i.imgur.com/H9LR3Bj.jpg"),
      Item(
          id: 2,
          seller: users[8],
          title: "iPhone 5",
          description: "My dear old iPhone 5. It stayed in my drawer for years, so I think it arrives the moment to give it away. Take care of it :)",
          mainImage:
      ...
      Item(
          ...
          seller: users[2],
          title: "Skateboard",
          description: "Skateboard in good condition. You can come this Saturday between 2.00 PM and 4.00 PM and take it.",
          mainImage:
      ...
      Item(
          ...
          description: "They are almost new, it was a gift of a friend but I don't like them too much (sorry Kevin <3)",
          mainImage: "https://i.imgur.com/VPyrXw3.jpg"),
      Item(
          id: 5,
          seller: users[3],
          title: "Vacuum cleaner",
          description: "Dyson Vacuum cleaner bought 4-5 years ago, The cable is broken so it should be substituted, but it works.",
          mainImage: "https://i.imgur.com/y3I1uLH.jpg"),
      Item(
          id: 6,
          seller: users[1],
          title: "Wooden table",
          description: "I am moving to Dallas and I need to give away some furniture. You need to come before the 18th otherwise I will must throw it in thrash :(",
          mainImage: "https://i.imgur.com/BpfV3WH.jpg"),
      Item(
          id: 7,
          seller: users[4],
          title: "Old couch",
          description: "White couch with tongs. Please come with a van to take it away.",
          mainImage: "https://i.imgur.com/yoOmSdf.jpg"),
      Item(
          id: 8,
          seller: users[9],
          title: "Pink office chair",
          description: "Sadly I need to give it away becaus we renew our office, but I worked 8 hours per day for 6 years on this chair. It is super comfortable, I promise. ",
          mainImage: "https://i.imgur.com/2tb88rW.jpg"),
      Item(
          id: 9,
          seller: users[0],
          title: "Big closet",
          description: "I am changing mine closet, so I give this away. If you want more picture just ask me in the chat. I prefer to give it to someone with good rewards, thanks!",
